...
%   2. A single experimental fatigue data point from DARPA Set-1 EOS.
...
%
% DARPA Set-1 EOS:
%   Nf_set1_exp : measured cycles to failure
%   A_set1_exp  : applied nominal strain amplitude, mm/mm
Nf_set1_exp       = [31056];
A_set1_exp        = [0.003];
...
error_bar_cycles  = error_bar_percent * Nf_set1_exp;
...
%
% eps_nom_target:
%   Target nominal strain amplitude, here taken from the experimental Set-1
%   loading amplitude.
%
% eps_nom_ref:
...
%   3. Experimental Set-1 EOS fatigue data point
