...
P60_d_ebsd = 44.693e-3;
std_d_ebsd = 28.655e-3;
...
mp.pool_length     = 0.360;

% Normalized semi-elliptical regions:
mp.core_rho        = 0.30;
mp.boundary_rho    = 0.85;
...
sigma_d  = [0.22, 0.28, 0.25];
rel_d    = [2.50, 0.75, 1.00];

sigma_ar = [0.18, 0.22, 0.20];
rel_ar   = [2.75, 0.75, 1.00];
...
stats(double(REG_BOUNDARY)).sigma_spread = 25;
stats(double(REG_BOUNDARY)).random_orientation_fraction = 0.25;
...
stats(double(REG_TRANS)).sigma_spread = 15;
stats(double(REG_TRANS)).random_orientation_fraction = 0.12;
