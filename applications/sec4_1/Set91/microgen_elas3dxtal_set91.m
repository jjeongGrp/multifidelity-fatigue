...
% after grain assignment. The resulting phase map can be used for downstream
% finite element or microstructure-based analyses.
%
% Inputs:
...
sigma_spread = 15;             % Angular spread in degrees for textured case
...
% Build a coarse spatial grid used to identify potentially relevant grains
% for each region of the domain. This reduces the number of grain-distance
% calculations required for each block.
